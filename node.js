...
function getSong(req, res) {
	...
	fs.readFile(`public/Discography/${req.params.filename}`, function (err, data) {
		let songs = [];
...
function addSong(req, res) {
	...
	fs.readFile(`public/Discography/${req.params.filename}`, function (err, data) {
		...
		song.push(newSong);
		fs.writeFile(`public/Discography/${req.params.filename}`,JSON.stringify(song),function(err){
				if (err){
